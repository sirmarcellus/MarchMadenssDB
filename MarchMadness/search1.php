...
<?php
    if(isset($_POST['Submit'])){
        ...
        $sql = "SELECT team_name,coach,seed FROM team WHERE team_name LIKE '%$search%' OR coach LIKE '%$search%' OR seed LIKE '%$search%'";
        ...
        if($queryRes > 0){
            while($row = mysqli_fetch_assoc($result)){
                echo "<div class='search-box'> 
                    ...
                    <p>School: ".$row['team_name']."</p> <p>Coach: ".$row['coach']."</p><p>Seed #".$row['seed']." </p>
