...
<?php
    if(isset($_POST['Submit'])){
        ...
        $sql = "SELECT player_name,position, team_name FROM player join team on school_id = team_id where player_name LIKE '%$search%'";
        ...
        if($queryRes > 0){
            while($row = mysqli_fetch_assoc($result)){
                echo "<div class='search-box'> 
                    ...
                    <p>".$row['player_name']." </p> <p>Position: ".$row['position']." </p>   <p>School: ".$row['team_name']." </p>
